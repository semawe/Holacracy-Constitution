...
*What conventional hierarchy calls "management" (telling people what to do, approving their decisions) does not disappear: it is transformed. Each Role's authority is explicitly defined and protected. No one may encroach on it. But no one may extend it beyond what Governance grants, either. Clear limits make freedom real.*

*This Constitution is a tool for organizations that want to be driven by a purpose rather than by the judgment of a single person at the top. It does not promise this will be easy: it is a practice, learned by doing.*
...
As a Role Lead, you are responsible for:

- **Sensing and processing Tensions.** Comparing the actual expression of your Role to its ideal potential. Each gap is a **"Tension"**. You are responsible for taking initiative to reduce them.
- **Clarifying and tracking your work.** Regularly defining the actions and outcomes worth pursuing in your Role, capturing them in writing, and keeping them up to date so they remain a trusted picture of your work.
...
A **"Circle"** is a container for organizing Roles and Policies around a common Purpose. The Roles and Policies within a Circle make up its **"Governance"**.

The inside of every Role is itself a Circle, which may in turn hold its own Roles and Policies. This inner Circle is a **"Sub-Circle"** of the Circle that holds it, and that broader Circle is its **"Super-Circle"**.
...
Any Circle may appoint a **"Facilitator"** and a **"Secretary"**. The Facilitator has the Purpose: "Circle governance and operational practices aligned with the Constitution". The Secretary has the Purpose: "Stabilize the Circle's constitutionally-required records and meetings". A Circle may add Accountabilities or Domains to these Roles, but may not amend their Purpose nor what the Constitution assigns them.

### 1.4 Circle Leads

*Stance: the Circle Lead carries the Purpose of their Role. They are not a manager in the conventional sense: they do not decide other people's work; they lay the groundwork by assigning Roles, resolving priority conflicts, and personally taking on whatever has not yet been entrusted to another Role.*

Serving as a Role Lead also means serving as the **"Circle Lead"** within that Role's internal Circle. The Circle Lead carries the Purpose of that Role, along with all of its Accountabilities that are not delegated to other Roles or processes within the Circle.

The Circle Lead is a Member of their own Circle, which they run from within, and a Member of the Super-Circle that holds their Role. They take part in the Governance Process of both.
...
*Stance: the Facilitator is in service of the process, in meetings and outside them. Their role is not to police but to help the Circle Members use the operational practices defined by this Constitution and by the Circle's policies. They do not weigh in on the content of decisions; they enable the processes that produce them.*
...
- may declare a Process Breakdown in their Circle or in a Sub-Circle;
- triggers new elections for elected Roles when their term expires.
...
*Intent note: Article 2 defines the concrete obligations that make the system work: being transparent about your work, processing others' requests, and prioritizing according to the shared rules rather than your own judgment. Without these duties, the distributed authority of Article 1 becomes unmanageable. One principle runs through the whole article: these are obligations of effort, not of outcome. To estimate is not to commit. To process a request is not to grant it. To prioritize is not to guarantee.*

### 2.1 Duty of Transparency

You must share, upon request from any Role Lead:
...
You must promptly process requests from other Role Leads:
...
*Intent note: relational agreements are this Constitution's only tool for acting on behavior. But not all agreements are of the same nature. Some are binding because they were made so explicitly: to leave them unilaterally is to leave the organization or to expose oneself to formal consequences. The others are tools of invitation: no one can be compelled to enter one, nor held prisoner to it. It is precisely this freedom to exit that makes them useful.*
...
*Intent note: Article 3 organizes day-to-day operational coordination. A Tactical Meeting differs from a conventional management meeting on one structural point: neither the process nor the content belongs to a single person. The process is set by the rules of the game and held by the Facilitator. The content comes from each participant, who brings their own items and their own requests. All are jointly responsible for moving the work forward. The meeting serves to unblock that work, not to supervise it. It may be held in person or remotely.*
...
To change a Circle's Governance (creating, amending, or removing a Role or a Policy, or holding an election), you must use the **"Integrative Decision-Making Process"** defined in this article.
...
1. **Clarifying questions.** The other Members may ask the Proposer to clarify the Proposal or the Tension. No reactions are allowed.
2. **Reaction round.** Each Member may share their reaction to the Proposal, in turn, with no dialogue and no reactions to reactions.
3. **Amend and clarify.** The Proposer may amend their own Proposal in light of the reactions, or clarify its intent. Any amendment must remain in service of the original Tension and not address the Tensions of other Members.
4. **Objection round.** Each Member states whether they have an Objection to the Proposal as amended. An **"Objection"** is valid only if all of the following are true:
   - it shows that the Proposal would reduce the Circle's capacity to enact its Purpose or Accountabilities;
   - it shows that the Proposal would limit the **"Objector's"** capacity to enact a Role they represent in the Circle;
   - the concern does not already exist in the absence of the Proposal;
   - the harm identified is certain to occur, or, if only anticipated, too great to risk trying the Proposal.

   A Proposal that violates this Constitution always constitutes a valid Objection.
5. **Integration.** For each valid Objection, the Proposer and the Objector seek together an amendment that resolves the Objection without losing the original Tension, with the help of the other Members if needed.

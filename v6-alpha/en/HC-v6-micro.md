...
The Organization may designate **"Partners"** to take part in its governance and operations, provided each Partner agrees to abide by all the provisions of this Constitution. No implicit expectation, and no dictate issued outside the authority granted by this Constitution, has any power over a Partner.
...
1. A **"Purpose"**: the capacity, potential, or goal that the Role pursues.
2. One or more **"Domains"**: assets, processes, or anything else the Role controls exclusively.
3. One or more **"Accountabilities"**: ongoing activities the Role carries out in service of other Roles or of its Purpose.
4. One or more **"Policies"**: grants or constraints of authority, or special provisions that apply within that Role.
...
**Duty of Transparency**: upon request from any Role Lead, you must share the status of your current work, your metrics, and any information that is readily available and would cause no harm to share. An estimate reflects your current context; it is not a promise.

**Duty of Processing**: you must promptly process requests from other Role Leads by defining a next step, explaining your refusal, or offering an alternative that meets the requester's intent.

**Duty of Prioritization**: you must process inbound requests ahead of your own work, attend meetings when explicitly asked to, and honor the official Strategies of your Circles, treating them as more important than your own judgment.

**Duty to honor Relational Agreements**: as a Partner, you may make **"Relational Agreements"** with other Partners to regulate how you work together. These agreements are of two kinds. Binding agreements (any commitment entered into in writing with the Organization whose terms provide no unilateral exit) remain fully enforceable and prevail over the other provisions of this article. Behavioral agreements (modes of communication, cooperation practices) are voluntary: no one may be compelled to enter one, and either party may end it at any time.
...
Any Partner may convene a **"Tactical Meeting"** to coordinate the work and engage one another in their responsibilities. The Secretary of each Circle schedules regular meetings for the Circle.

A default process is available in the official facilitation guide. Each Circle may adopt its own process by writing a Policy.
...
In that case, you must immediately inform the affected Role Leads and refrain from doing the same again if asked.
